%% The styleLoss helper function computes the weighted mean squared difference between 
%the Gram matrix of the style image features and the Gram matrix of the transfer image
%features.
